                ...
                <div class="helpInfo">
                    ...
                    <dd class="helpBox stepThree" style="display:none;">
                        ...
                        <p>晒出您收到的商品实物图片甚至您的靓照，说出您的<%=ApplicationListenerImpl.sysConfigureJson.getShortName()%>心得，让大家一起分享您的快乐。
                          <br />在您收到商品后，您只需登录网站完成晒单，并通过审核，即可获得1000积分奖励。在您成功晒单后，您的晒单会出现在网站"晒单分享"区，与大家分享喜悦。
                        </p>
                    </dd>
                </div>
                <div class="helpInfo">
                    ...
                    <dd class="helpBox stepThree" style="display:none;">
                        ...
                        <p><strong>A:</strong>在您收到商品后，登录<%=ApplicationListenerImpl.sysConfigureJson.getShortName()%>网，进入"我的<%=ApplicationListenerImpl.sysConfigureJson.getShortName()%>中心"，在“晒单分享”区发布晒单信息，通过审核后，您还可获得400-1500积分奖励。在您成功晒单后，您的晒单会出现在网站“晒单分享”区，与大家分享喜悦。</p>
