...
<input type="hidden" value="${userId }" id="userId"/>
    <section class="clearfix g-member">
	    <article class="clearfix m-round g-userMoney">
		    可用积分<span class="orange">${user.commissionPoints}</span>
	    </article>
	    <article class="mt10 m-round">
		    <ul class="m-userMoneyNav">
			    <li style="float: left;height: 41px;overflow: hidden;position: relative;width: 100%;"><a id="btnConsumption" href="javascript:;"><b>我的积分</b></a></li>
		    </ul>
