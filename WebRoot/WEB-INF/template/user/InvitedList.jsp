...
<html>
  <head>
    ...
    <title>邀请记录_<%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%> 一元<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %> <%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>网</title>
    ...
    <section class="clearfix g-member">
	    <article class="mt10 m-round">
		    <ul class="m-userMoneyNav">
			    <li style="float: left;height: 41px;overflow: hidden;position: relative;width: 100%;"><a id="btnConsumption" href="javascript:;"><b>邀请记录</b></a></li>
		    </ul>
