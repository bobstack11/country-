							...
							if (g != "") {
								...
								for (var i = 0; i < e; i++) {
									...
									var c = '<ul id="'
											...
											+ $img
											+ h[i].productImg
											+ ' "></li><li class="revConR"><dl><dd><img name="uImg" uweb="'
											+ h[i].userId
											+ '.html" src="'
											+ f
											+ '"></dd><dd><span>\u83b7\u5f97\u8005<strong>\uff1a</strong><a name="uName" uweb="'
											+ h[i].userId
											+ '" class="rUserName blue">'
											+ h[i].userName
											+ '</a></span>\u672c\u671f\u4e91\u8d2d<strong>\uff1a</strong><em class="orange arial">'
											+ h[i].buyNumberCount
											+ '</em>\u4eba\u6b21</dd></dl><dt>\u5e78\u8fd0\u4e91\u8d2d\u7801\uff1a<em class="orange arial">'
											+ h[i].randomNumber
											+ '</em><br/>\u63ed\u6653\u65f6\u95f4\uff1a<em class="c9 arial">'
											+ h[i].announcedTime
