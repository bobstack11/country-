...
public abstract class JSONReader
{
  ...
  private Object read()
  {
    ...
    {
    case '"': 
      this.token = string(); break;
    case '[': 
      this.token = array(); break;
    case ']': 
      this.token = ARRAY_END; break;
    case ',': 
      this.token = COMMA; break;
    case '{': 
      this.token = object(); break;
    case '}': 
      this.token = OBJECT_END; break;
    case ':': 
      this.token = COLON; break;
    case 't': 
      next();next();next();
