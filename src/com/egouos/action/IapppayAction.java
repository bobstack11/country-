...
public class IapppayAction extends BaseAction {
	...
	private static final String IAPPPAY_GATEWAY = "https://web.iapppay.com/h5/exbegpay";
	...
	public String goPay() throws Exception {
		...
		String notify_url = conf.getWeixinUrl() + "/iapppay/notifyUrl.action";
		String return_url = conf.getWeixinUrl() + "/iapppay/returnUrl.action";
