...
public class Sampler2
{
	...
	// 接口帐号
	private static final String account = "1001@501172940001";
	
	// 接口密钥
	private static final String authkey = "2B35E1A3F780C7EB79FCA1F0FBEF643C";
	
	// 通道组编号
	private static final int cgid = 52;
	
	// 默认使用的签名编号(未指定签名编号时传此值到服务器)
	private static final int csid = 5228;
	...
	public static void main(String[] args) throws Exception
	{
		...
		List<SendResultBean> listItem = sendOnce("13758249979", "您本次的手机验证码是：123456，请即时填写，祝您好运。");
		if(listItem != null)
		{
