  ...
  implements Runnable
{
  ...
  public void run()
  {
    sendMailBySpring(this.sender, this.mailto, this.subject, this.content, this.attachList);
  }
  ...
  private synchronized boolean sendMailBySpring(JavaMailSenderImpl sender, String mailto, String subject, String content, List<String> attachList)
  {
    ...
    {
      this.log.error("邮件发送失败!!! 标题:" + subject + "  收件人:" + mailto + "  发件人:" + sender.getUsername(), e);
      return false;
    }
    ...
    this.log.info("邮件发送成功! 标题:" + subject + "  收件人:" + mailto + "  发件人:" + sender.getUsername());
    return true;
  }
}
