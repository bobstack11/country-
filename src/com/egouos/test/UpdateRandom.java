...
public class UpdateRandom
{
  ...
  public void go()
  {
    for (int i = 0; i < 20; i++)
    {
      Pagination page = this.latestlotteryService.LatestAnnounced(i, 20);
      ...
      for (Latestlottery latestlottery : objList) {
        for (int j = 0; j < 100; j++)
        {
          ...
          Pagination datePage = this.latestlotteryService.getLotteryDetailBybuyerList(latestlottery.getSpellbuyProductId(), j, 20);
          ...
          for (int k = 0; k < dataList.size(); k++)
          {
            ...
            this.randomnumberService.add(randomnumber);
          }
        }
      }
    }
