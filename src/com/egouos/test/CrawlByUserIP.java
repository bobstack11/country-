    ...
    throws ClientProtocolException, IOException
  {
    ...
    while (count-- > 0)
    {
      ...
      for (Object object2 : Rows)
      {
        ...
        this.user.setUserPwd("1ypg.com");
        this.user.setIpLocation(obj.getString("buyIPAddr"));
        this.user.setIpAddress(obj.getString("buyIP"));
        this.user.setNewDate(nowDate);
        ...
        User user2 = this.userService.userByIsUserName(userName);
        if (user2 == null) {
