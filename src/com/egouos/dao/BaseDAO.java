...
public abstract interface BaseDAO
{
  ...
  public abstract Object loadObject(String hql, final String alias, final boolean lock);
  ...
  public abstract List query(final String hql, final String alias, boolean lock);
  
  public abstract List<Object> query(final String hql, final int pageNo, final int pageSize,
  ...
  public abstract List sqlQuery(StringBuffer sql, Map<String, Class> entityMap, Pagination page, final boolean lock);
